...
using Joița_Cristina_Lab2;
using Joița_Cristina_Lab2.Data;

namespace Joița_Cristina_Lab2.Models

{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Joița_Cristina_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Joița_Cristina_Lab2Context context,
